...
TEST_CASE("Test invalid file signature error") {
    ...
    CHECK_ERROR_MSG(mds.upload_net_from_file("test_sign_method.mlp"), "Model builder: This file is not an MLP model file");
}
...
TEST_CASE("Test damaged file error") {
    ...
    CHECK_ERROR_MSG(mds.upload_net_from_file("test_damaged.mlp"), "Model builder: This file was damaged or saved incorrectly");
}